...
${detailErrorMessage}
${JSON.stringify(row)}` : (0, _formatErrorMessage2.default)(85, detailErrorMessage, JSON.stringify(row)));
  }
}
...
const updateCacheWithNewRows = ({
  ...
  if (previousCache.updates.type === 'full') {
    throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: Unable to prepare a partial update if a full update is not applied yet.' : (0, _formatErrorMessage2.default)(86));
  }
